...
:::info 首先先讓我們來看看 [Observer Pattern](https://en.wikipedia.org/wiki/Observer_pattern) 的定義：
...
眼尖聰明如你，可能會發現，上方 notify 當中所使用的 observer 多了一個 `id` 介面可以做使用，目的是為了讓 notify 能辨別 observer，只通知目標觀察者。
